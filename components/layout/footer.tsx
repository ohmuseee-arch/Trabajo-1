...
export function Footer() {
  return (
    <footer className="border-t border-[var(--border-soft)] bg-white/85 py-10 backdrop-blur-sm">
      <Container className="flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <p className="mt-4 text-sm text-[var(--text-secondary)]">
            © 2026 FitVirtual. Todos los derechos reservados a Natalia Ortiz Martinez.
          </p>
          <p className="mt-1 text-sm text-[var(--text-tertiary)]">
            Diseno y desarrollo por Natalia Ortiz Martinez.
          </p>
        </div>
